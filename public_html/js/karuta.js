...
100: 'じゅんとくいん',
  ...
  getYomi: function(uta_no) {
    ...
    var ret = {};
    ret.kami1 = this.ykami1_list[uta_no];
    ret.kami2 = this.ykami2_list[uta_no];
    ret.kami3 = this.ykami3_list[uta_no];
    ret.shimo1 = this.yshimo1_list[uta_no];
    ret.shimo2 = this.yshimo2_list[uta_no];
